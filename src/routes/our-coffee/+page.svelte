<script lang="ts">
	...
	const gallery = [
		{
			...
			caption: 'Selective harvest'
		},
		{
			src: '/image10.webp',
			alt: 'Coffee drying beds beneath a thatched hut',
			caption: 'Sun-drying'
		},
		{
			src: '/image11.webp',
			alt: 'Workers tending vast drying beds at sunset',
			caption: 'Turning the beds'
		},
		{
			src: '/image6.webp',
			alt: 'Hands sorting cherries at a washing station',
			caption: 'Wet processing'
		},
		{
			src: '/image14.webp',
			alt: 'Hand cradling a basket of ripe cherries',
	...
	const subRegions = [
		{
			region: 'Limmu Kossa Woreda',
			altitude: '1750–2000m',
			notes: 'Sweet with a lingering spicy note'
		},
		{
			region: 'Limmu Seqa Woreda',
			altitude: '1850–2100m',
			notes: 'Sweet, winey, and citrus notes'
		},
		{
			region: 'Manna Woreda',
			altitude: '1600–2000m',
	...
	const farms = [
		{
			...
			image: '/image8.webp',
			stats: [
				'200 hectares (180 arable)',
				'22 tree species for shade',
				'5,000+ out-growers within 50km'
			],
			description:
	...
	const regions = [
		...
		},
		{
			...
			flavor:
				'Full-bodied with low acidity and notes of dark chocolate, nuts, and earthy undertones'
		},
		{
			name: 'Limmu',
			...
			flavor:
				'Well-balanced with medium acidity and notes of tropical fruits, cinnamon, and caramel'
		}
	];
...
<section class="relative isolate overflow-hidden py-28 lg:py-36">
	...
	/>
	<div
		class="enter-fade absolute inset-0 -z-10 bg-linear-to-b from-black/75 via-black/60 to-black/80"
		style="--enter-duration: 1400ms"
	></div>
	<div class="container mx-auto px-4 text-center sm:px-6">
		<h1
			class="enter-rise font-heading text-5xl font-bold tracking-tight text-white md:text-6xl"
			style="--enter-delay: 150ms"
		>
			Our Coffee
		</h1>
		<p class="enter-up mt-4 text-xl text-white/85" style="--enter-delay: 380ms">
		...
		<p class="enter-up mx-auto mt-8 max-w-2xl text-lg text-white/80" style="--enter-delay: 520ms">
			We source premium Arabica beans from Ethiopia's Jimma Zone, using selective harvesting of ripe
			cherries and adaptable processing methods tailored to customer preferences.
		</p>
	</div>
</section>
...
<section class="py-16">
	<div class="container mx-auto px-4 sm:px-6">
		<h2 use:reveal class="text-center font-heading text-3xl font-bold md:text-4xl">Our Farms</h2>
		...
		<div class="mx-auto mt-16 max-w-4xl">
			<h3 use:reveal class="text-center text-xl font-semibold">
				Atnago Farm — Sub-regions & Profiles
			</h3>
			<div
			...
			>
				<table class="w-full text-left text-sm">
					...
					<tbody>
						{#each subRegions as row, i (row.region)}
							<tr
...
<section class="bg-muted/30 py-20">
	<div class="container mx-auto px-4 sm:px-6">
		<div class="mx-auto max-w-2xl text-center">
			<h2 use:reveal class="font-heading text-3xl font-bold md:text-4xl">
				Regions & Tasting Profiles
			</h2>
			<p use:reveal={{ delay: 120 }} class="mt-4 text-muted-foreground">
...
<section class="py-20">
	<div class="container mx-auto px-4 sm:px-6">
		<div class="mx-auto max-w-2xl text-center">
			<h2 use:reveal class="font-heading text-3xl font-bold md:text-4xl">Harvesting to Packing</h2>
			<p use:reveal={{ delay: 120 }} class="mt-4 text-muted-foreground">
	...
	<div class="container mx-auto px-4 sm:px-6">
		<ol class="mx-auto mt-12 max-w-2xl space-y-4">
			{#each traceabilitySteps as step, i (step)}
				<li
					use:reveal={{ delay: stagger(i, 60, 3), x: -16, y: 8, duration: 750 }}
					class="flex gap-4"
				>
					<span
...
<section class="bg-muted/30 py-20">
	<div class="container mx-auto px-4 sm:px-6">
		<h2 use:reveal class="text-center font-heading text-3xl font-bold md:text-4xl">
