...
export const load: PageServerLoad = async () => {
	const [farmCount, regions, images, partnerCount, ventureCount, faqCount, quotes, unread] =
		await Promise.all([
			liveCount(farms),
	...
	return {
		unread,
		stats: [
			{ label: 'Farms', value: farmCount, href: '/dashboard/content/farms' },
			...
			{ label: 'Ventures', value: ventureCount, href: '/dashboard/content/ventures' },
