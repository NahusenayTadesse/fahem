			...
			items: [
				{
					...
					items: [
						...
						{ title: 'Why Fahem', url: '/dashboard/content/value-props' }
					]
				},
				{
					title: 'Coffee',
					...
					icon: Coffee,
					items: [
						{ title: 'Farms', url: '/dashboard/content/farms' },
						{ title: 'Farm Sub-regions', url: '/dashboard/content/sub-regions' },
						{ title: 'Coffee Grades', url: '/dashboard/content/coffee-products' },
				...
				},
				{
					...
					items: [
						...
						{ title: 'Ventures', url: '/dashboard/content/ventures' },
