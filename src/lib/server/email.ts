...
// --- Brand constants ---
const BRAND_NAME = 'Fahem General Trading';
const BRAND_URL = 'https://fahemgeneraltrading.com';
const BRAND_LOGO = 'https://fahemgeneraltrading.com/logo.png';
const BRAND_PRIMARY = '#ba7345';
const BRAND_PRIMARY_DARK = '#6b3f22';
